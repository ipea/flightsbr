...
- Minor changes:
  ...
  - The function
    [`read_aircrafts()`](https://ipeagit.github.io/flightsbr/reference/read_aircrafts.md)
    ...
    are identical.
  - [`read_airfares()`](https://ipeagit.github.io/flightsbr/reference/read_airfares.md)
    and
...
- Bug fixes:
  ...
  - Fixed the `select` parameter in
    ...
    [`read_flights()`](https://ipeagit.github.io/flightsbr/reference/read_flights.md).
  - Fixed
    [`get_airfares_dates_available()`](https://ipeagit.github.io/flightsbr/reference/get_airfares_dates_available.md)
    (used internally by
    [`read_airfares()`](https://ipeagit.github.io/flightsbr/reference/read_airfares.md))
  ...
  - Fixed
    [`get_airfares_dates_available()`](https://ipeagit.github.io/flightsbr/reference/get_airfares_dates_available.md)
    and
    [`latest_airfares_date()`](https://ipeagit.github.io/flightsbr/reference/latest_airfares_date.md)
...
- Breaking changes:
  - The names of all columns in the data outputs are now cleanned with
    {janitor}
  - Function
    [`read_airports()`](https://ipeagit.github.io/flightsbr/reference/read_airports.md)
...
- Minor changes:
  ...
  - The function
    [`get_airport_movement_dates_available()`](https://ipeagit.github.io/flightsbr/reference/get_airport_movement_dates_available.md)
...
- Bug fixes:
  ...
  - Using a simpler / slightly faster version of
    [`latlon_to_numeric()`](https://ipeagit.github.io/flightsbr/reference/latlon_to_numeric.md)
...
- Major changes:
  ...
  - new internal support functions:
    - `split_date()`: Split a date from yyyymmm to year yyyy and month
      mm
    - [`check_date()`](https://ipeagit.github.io/flightsbr/reference/check_date.md):
      Check whether date input is acceptable
    - [`generate_all_months()`](https://ipeagit.github.io/flightsbr/reference/generate_all_months.md):
    ...
    - [`get_flight_dates_available()`](https://ipeagit.github.io/flightsbr/reference/get_flight_dates_available.md):
      Retrieve from ANAC website all dates available for flights data
    - [`download_flights_data()`](https://ipeagit.github.io/flightsbr/reference/download_flights_data.md):
      Download and read ANAC flight data
    - [`get_airport_movements_url()`](https://ipeagit.github.io/flightsbr/reference/get_airport_movements_url.md):
      Put together the url of airport movement data files
    - [`get_airport_movement_dates_available()`](https://ipeagit.github.io/flightsbr/reference/get_airport_movement_dates_available.md):
      Retrieve all dates available for airport movements data
    - [`download_airport_movement_data()`](https://ipeagit.github.io/flightsbr/reference/download_airport_movement_data.md):
